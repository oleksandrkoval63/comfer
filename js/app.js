 ...
 */
    ...
    (() => {
        ...
        function findTabIndexByHash(hash) {
            const tabs = document.querySelectorAll("[data-hash-name-url]");
            let tabIndex = -1;
            tabs.forEach(((tabTitle, index) => {
                const dataHashNameUrl = tabTitle.getAttribute("data-hash-name-url");
                if (dataHashNameUrl === hash) tabIndex = index;
            }));
            return tabIndex;
        }
        function formatTabIndex(number) {
            let tabsActiveHash = [];
            if (number < 10) {
                tabsActiveHash.push("0");
                tabsActiveHash.push(number.toString());
            } else tabsActiveHash.push(number);
            return tabsActiveHash;
        }
        function tabs() {
            ...
            if (tabs.length > 0) {
                ...
                if (hash) {
                    tabsActiveHash = formatTabIndex(findTabIndexByHash(hash));
                ...
                if (tabsContent.length > 0) {
                    ...
                    tabsContent.forEach(((tabsContentItem, index) => {
                        if (tabsTitles[index].classList.contains("_tab-active")) {
                            ...
                            if (isHash && !tabsContentItem.closest(".popup")) setHash(tabsBlock.getAttribute("data-hash-name-url"));
            ...
            function setTabsAction(e) {
                ...
                if (el.closest("[data-tabs-title]")) {
                    ...
                    if (!tabTitle.classList.contains("_tab-active") && !tabsBlock.querySelector("._slide")) {
                        ...
                        setHash(tabTitle.getAttribute("data-hash-name-url"));
                    }
                    e.preventDefault();
                }
            }
        ...
        if (document.querySelector("#phone")) modules_flsModules.inputmask = new Inputmask({
        ...
        function initSliders() {
            ...
            if (document.querySelector(".home__slider")) new swiper_core_Swiper(".home__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 6,
            ...
            if (document.querySelector(".grow__slider")) new swiper_core_Swiper(".grow__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".swiper-pagination-grow",
                    clickable: true
                },
                on: {}
            });
            if (document.querySelector(".domekt-benefits-1__slider")) new swiper_core_Swiper(".domekt-benefits-1__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".swiper-pagination-benefits-1",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".domekt-benefits-2__slider")) new swiper_core_Swiper(".domekt-benefits-2__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".swiper-pagination-benefits-2",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".domekt-benefits-3__slider")) new swiper_core_Swiper(".domekt-benefits-3__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".swiper-pagination-benefits-3",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".single-product__slider")) new swiper_core_Swiper(".single-product__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                on: {
                    slideChange: function() {
                        ...
                        setActiveBottomSlide(activeIndex);
                        function setActiveBottomSlide(index) {
                            var bottomSlides = document.querySelectorAll(".single-product-paginetion__slide");
                            bottomSlides.forEach((function(slide) {
                                slide.classList.remove("per-active");
                            }));
                            bottomSlides[index].classList.add("per-active");
                        }
                    }
                }
            });
            if (document.querySelector(".single-product-paginetion__slider")) new swiper_core_Swiper(".single-product-paginetion__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
...
***************************************************************************** */
        ...
        window.addEventListener("DOMContentLoaded", (function() {
            ...
            const regex = /sub-menu/;
            elements.forEach((function(element) {
                if (element.classList) for (let i = 0; i < element.classList.length; i++) if (regex.test(element.classList[i])) {
                    const menuItem = element.closest(".menu__item");
                    if (menuItem) menuItem.classList.add("has-under-menu");
                    break;
                }
            }));
            const closeMenuButtons = document.querySelectorAll(".header__close");
            closeMenuButtons.forEach((el => {
                el.addEventListener("click", functions_menuClose);
            }));
            function addClickHandlersForMobile() {
                if (isMobile.any()) {
                    document.querySelectorAll(".has-under-menu > a");
                    function addActiveClass(event) {
                        const ulElement = event.currentTarget.querySelector("ul");
                        const classes = ulElement.classList;
                        classes.add("active-sub-menu");
                    }
                    function removeActiveClass(event) {
                        const parentElement = event.currentTarget.parentElement;
                        setTimeout((() => {
                            parentElement.classList.remove("active-sub-menu");
                        }), 100);
                        event.preventDefault();
                    }
                    function addClickHandlersToElementsWithClass() {
                        const elementsWithClass = document.querySelectorAll(".has-under-menu");
                        elementsWithClass.forEach((el => {
                            el.addEventListener("click", addActiveClass);
                        }));
                        const returnBackElements = document.querySelectorAll(".return-back");
                        returnBackElements.forEach((el => {
                            el.addEventListener("click", removeActiveClass);
                        }));
                    }
                    addClickHandlersToElementsWithClass();
                }
            }
            addClickHandlersForMobile();
            const returnBackButtons = document.querySelectorAll(".return-back");
            returnBackButtons.forEach((button => {
                const parentMenuItem = button.parentElement.parentElement;
                if (parentMenuItem) {
                    const parentText = parentMenuItem.querySelector("a").textContent.trim();
                    const returnBackDiv = button.querySelector("div");
                    if (returnBackDiv) returnBackDiv.textContent = parentText;
                }
            }));
            const titleElements = document.querySelectorAll(".spollers__title");
            const filtersElement = document.querySelector(".document__filters");
            const closeElement = document.querySelector(".document__close");
            const showResultElement = document.querySelector(".document__show-result");
            if (closeElement) {
                ...
                titleElements.forEach((titleElement => {
                    titleElement.addEventListener("click", addFilterClass);
                }));
                closeElement.addEventListener("click", removeFilterClass);
                showResultElement.addEventListener("click", removeFilterClass);
                closeElement.addEventListener("click", removeFilterClass);
            }
        }));
        window["FLS"] = false;
